...
sealed class MoreUseCase {
  ...
  static Future<bool> sendCustomerCenterInquiry(String text) async {
    try {
      ...
      log("Customer center inquiry sent successfully");
      return true;
    } catch (e) {
  ...
  static Future<bool> switchAdMarketingAlarm(bool value) async {
    try {
      ...
      log("Ad marketing alarm switched to $value successfully");
      return true;
    } catch (e) {
  ...
  static Future<bool> switchChatCreateAlarm(bool value) async {
    try {
      ...
      log("Chat create alarm switched to $value successfully");
      return true;
    } catch (e) {
  ...
  static Future<bool> switchChatAlarm(bool value) async {
    try {
      ...
      log("Chat alarm switched to $value successfully");
      return true;
    } catch (e) {
  ...
  static Future<bool> switchDmAlarm(bool value) async {
    try {
      ...
      log("DM alarm switched to $value successfully");
      return true;
    } catch (e) {
  ...
  static Future<bool> switchFriendAddReject(bool value) async {
    try {
      ...
      log("Friend add reject switched to $value successfully");
      return true;
    } catch (e) {
