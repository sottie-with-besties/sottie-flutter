...
part of 'post_production_repository_impl.dart';
...
class _PostProductionRepositoryImpl implements PostProductionRepositoryImpl {
  ...
  @override
  Future<HttpResponse<dynamic>> makePost(
      {required Map<String, dynamic> postSetting}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Content-Type': 'application/json'};
    _headers.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    _data.addAll(postSetting);
  ...
  Future<HttpResponse<dynamic>> postJoin(
      {required Map<String, dynamic> postJoinInfo}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Content-Type': 'application/json'};
    _headers.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    _data.addAll(postJoinInfo);
    final _options = _setStreamType<HttpResponse<dynamic>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
  ...
  @override
  Future<HttpResponse<dynamic>> postExit() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Content-Type': 'application/json'};
    _headers.removeWhere((k, v) => v == null);
