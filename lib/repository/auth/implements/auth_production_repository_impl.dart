...
part 'auth_production_repository_impl.g.dart';

/// Authentication 관련 Rest Api 통신 코드
@RestApi(baseUrl: productionServerIp)
abstract class AuthTokenProductionRepositoryImpl implements AuthRepository {
  factory AuthTokenProductionRepositoryImpl(Dio dio, {String baseUrl}) =
      _AuthTokenProductionRepositoryImpl;
