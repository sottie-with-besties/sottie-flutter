...
class FriendDmTab extends StatefulWidget {
  const FriendDmTab({
    super.key,
    this.avatarId,
  });
  ...
  @override
  State<FriendDmTab> createState() => _FriendDmTabState();
}

class _FriendDmTabState extends State<FriendDmTab> with WidgetsBindingObserver {
  ...
  void didChangeMetrics() {
    ...
    setState(() {
      _boxHeight = 350 * hu - keyboardHeight / 5;
    });
  }
