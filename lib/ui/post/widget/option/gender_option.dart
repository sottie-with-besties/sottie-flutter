  ...
  Widget build(BuildContext context) {
    ref.listen(numOfMemberProvider, (_, peopleNum) {
      if (peopleNum == 1) {
        _peopleNumIsSelected = false;
        postOptionsSetting.genderRestriction = PostGenderRestriction.NONE;
        postOptionsSetting.maleNum = 0;
        postOptionsSetting.femaleNum = 0;
      } else {
        _peopleNumIsSelected = true;
                  ...
                  if (val == true) {
                    ...
                    postOptionsSetting.maleNum =
                        (postOptionsSetting.peopleNum / 2)
                            .floorToDouble()
                            .toInt();
                    postOptionsSetting.femaleNum =
                        postOptionsSetting.peopleNum -
                        postOptionsSetting.maleNum;
                  } else {
                    postOptionsSetting.genderRestriction =
                        PostGenderRestriction.NONE;
                        ...
                        Slider(
                          ...
                          onChanged: (val) {
                            if (_sliderCondition()) {
                              ...
                              postOptionsSetting.femaleNum =
                                  (postOptionsSetting.peopleNum - val).toInt();

                              if (postOptionsSetting.maleNum ==
                                  postOptionsSetting.peopleNum) {
                                postOptionsSetting.genderRestriction =
                                    PostGenderRestriction.MALE;
                              } else if (postOptionsSetting.femaleNum ==
                                  postOptionsSetting.peopleNum) {
                                postOptionsSetting.genderRestriction =
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: SizedBox(
                                  child: Text(
                                    "${postOptionsSetting.peopleNum - postOptionsSetting.maleNum} 여자",
                                    overflow: TextOverflow.ellipsis,
