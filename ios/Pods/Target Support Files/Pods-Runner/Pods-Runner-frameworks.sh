...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/auth_button_kit/auth_button_kit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/bootpay_webview_flutter_wkwebview/bootpay_webview_flutter_wkwebview.framework"
